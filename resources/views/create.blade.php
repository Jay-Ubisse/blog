    ...
    <section class="w-[90%] mx-auto mt-10 bg-white p-5 rounded shadow-md shadow-slate-400">
        ...
        <form method="POST" action="{{ route('posts.store') }}" class="mt-5 flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <input type="text" name="title" placeholder="Insert your blog title" class="outline-none rounded border border-[#000814] px-2 py-4 focus:border-2">
            </div>
            <div class="flex flex-col gap-2">
                <label for="description" class="text-lg text-[#000814] font-medium">Description</label>
                <textarea type="text" name="description" placeholder="Insert your blog description" class="outline-none rounded border border-[#000814] px-2 py-4 focus:border-2"></textarea>
            </div>
            <button type="submit" class="w-[20%] rounded h-12 mx-auto bg-[#000814] text-white font-medium">Publish Post</button>
        </form>
    </section>
@endsection
